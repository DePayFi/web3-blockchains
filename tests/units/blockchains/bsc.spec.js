...
describe('bsc', () => {
  ...
  it('provides basic structured data', () => {
    ...
    expect(blockchain.label).toEqual('Binance Smart Chain');
    expect(blockchain.fullName).toEqual('Binance Smart Chain Mainnet');
    ...
    expect(blockchain.currency.name).toEqual('Binance Coin');
